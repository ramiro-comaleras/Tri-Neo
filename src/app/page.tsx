    ...
    <main className="landing-body overflow-x-hidden">
      ...
      <section className="section-padding relative">
        ...
        <div className="container-narrow text-center reveal">
          ...
          <div className="aspect-[9/16] w-full max-w-xs mx-auto rounded-3xl overflow-hidden relative shadow-2xl flex items-center justify-center p-2 bg-gradient-to-tr from-white/5 to-white/10 ring-1 ring-white/10">
             <video 
               autoPlay 
               loop 
               muted 
